  ...
  return (
    <div className="bg-[#35374f] mt-4 p-4 rounded-2xl">
      <div className="mb-2">
        ...
        <input value={userMsg.username} onChange={(e) => setUserMsg({ ...userMsg, username: e.target.value })} className="rounded-2xl w-full p-2 " placeholder="Enter Your Username..." id="username" type="text" />
      </div>
      <div className="mb-2">
        <label htmlFor="question" className="text-[#f2f1f1]">Your Question</label>
        <textarea value={userMsg.message} onChange={(e) => setUserMsg({ ...userMsg, message: e.target.value })} className="rounded-2xl w-full p-2 h-[100px] resize-none" placeholder="Enter Your Question..." id="question" />
      </div>
