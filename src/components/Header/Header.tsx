      ...
      <div className="header-menu flex items-center gap-2 pl-5 pr-5">
        <div className="flex gap-4 items-center">
          ...
          {!isAuth ? (
            <button
              type="button"
              className="py-1 px-1 rounded-full hover:bg-light transition"
              onClick={() => setUserMenuOpen(!userMenuOpen)}
            >
              <svg focusable="false" aria-hidden="true" width="32" height="32" viewBox="0 0 24 24">
